    ...
    <div className='transition-opacity ease-in duration-500 opacity-100 border-t-2 pt-2'>
      ...
      <div className='flex flex-col sm:flex-row gap-12 sm:gap-12'>
        ...
        <div className='flex-1 '>
          <h1 className='text-2xl font-medium mt-3'>{itemData.name}</h1>
          ...
          <p className='text-3xl font-medium mt-5' >{currency}{itemData.price}</p>
          <p className='mt-5 md:w-4/5 text-gray-500 '>{itemData.description}</p>
          ...
          <button onClick={() => addToCart(itemData._id, size)}
      ...
      {/* <Relatedproducts category={itemData?.category} subcategory={itemData?.subcategory} /> */}
    </div>
