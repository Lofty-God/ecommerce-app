            ...
            <div key={index} className='py-4 border-t border-b text-gray-700 flex flex-col md:flex-row items-center md:justify-between gap-4'>
              ...
              <div className='flex sm:w-1/2 justify-between'>
                <div className='flex items-center gap-4'>
                  <p className='md:w-2 h-2 rounded-full bg-green-600'></p>
                  <p className='text-sm text-gray-500 font-medium'>{item.status} </p>
                </div>
                <button onClick={loadOrderData} className='border cursor-pointer text-gray-700 font-medium' >Track Order</button>
              </div>
            </div>
